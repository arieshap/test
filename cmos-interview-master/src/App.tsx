              ...
              <React.Fragment key={`${term}-${i}`}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="cursor-help border-b border-dotted border-blue-400 text-blue-700 font-medium px-0.5 hover:bg-blue-50 transition-colors">
                      {s}
                    </span>
                  </TooltipTrigger>
          ...
          >
            <Card className="glass-card border-t-4 border-t-blue-600">
              <CardHeader className="text-center space-y-4">
                ...
                <CardTitle className="text-4xl font-bold tracking-tight">CMOS Interview Master</CardTitle>
                <CardDescription className="text-lg">
                  Professional-grade interview preparation for Analog IC Design roles.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="p-4 bg-slate-100 rounded-lg text-center">
                    ...
                    <p className="text-sm font-semibold">200 Pool</p>
                  </div>
                  <div className="p-4 bg-slate-100 rounded-lg text-center">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <button className="p-4 bg-slate-100 hover:bg-slate-200 rounded-lg text-center transition-colors">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button 
                          ...
                          className={`w-10 h-5 rounded-full transition-colors relative ${isOffline ? 'bg-blue-600' : 'bg-slate-300'}`}
                        >
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <input 
                          ...
                          className="w-16 px-2 py-1 border rounded-md text-center font-bold text-blue-600 focus:ring-2 focus:ring-blue-500 outline-none"
                        />
                      </div>
                      <div className="flex gap-2">
              ...
              <CardFooter>
                <Button onClick={handleStart} className="w-full h-12 text-lg font-semibold bg-blue-600 hover:bg-blue-700">
          ...
          >
            <div className="flex justify-between items-end mb-2">
              ...
              <div className="text-right">
                ...
                <p className="text-xl font-bold text-blue-600 font-mono">{answers.length > 0 ? Math.round((score / answers.length) * 100) : 0}%</p>
              </div>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                >
                  {currentQuestion.options.map((option, idx) => {
                    ...
                    let variant = "border-slate-200 hover:border-blue-300";
                    if (isAnswered) {
                      if (isCorrect) variant = "border-green-500 bg-green-50 ring-1 ring-green-500";
                      else if (isSelected) variant = "border-red-500 bg-red-50 ring-1 ring-red-500";
                      else variant = "opacity-50 border-slate-200";
                    } else if (isSelected) {
                      variant = "border-blue-600 bg-blue-50 ring-1 ring-blue-600";
                    }

                    return (
                      <label
                        key={idx}
                        className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer transition-all ${variant}`}
                      >
                  ...
                  {isAnswered && (
                    ...
                    >
                      ...
                      <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                        ...
                        {aiExplanation ? (
                          <div className="mt-4 p-3 bg-blue-50 border border-blue-100 rounded-md text-sm text-blue-800 italic">
                          ...
                          <Button 
                            ...
                            className="mt-4 text-blue-600 hover:text-blue-700 hover:bg-blue-50 p-0 h-auto"
                          >
          ...
          >
            <Card className="glass-card border-t-4 border-t-green-600">
              ...
              <CardFooter className="flex flex-col gap-2">
                ...
                <div className="flex gap-2 w-full">
                  {mistakes.length > 0 && (
                    <Button variant="secondary" onClick={startDeepReview} className="flex-1 h-12 border border-blue-200 text-blue-700">
        ...
        {state === 'review' && mistakes.length > 0 && (
          ...
          >
            <Card className="glass-card border-t-4 border-t-blue-600">
              ...
              <CardFooter>
                <Button onClick={nextReview} className="w-full h-12 bg-blue-600 hover:bg-blue-700">
            ...
            <Card className="glass-card border-t-4 border-t-blue-600">
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>Mastery tracking for all {questions.length} interview questions.</CardDescription>
                </div>
                          ...
                          <React.Fragment key={q.id}>
                            ...
                            <TooltipContent className="bg-slate-900 text-white p-3">
                              <div className="space-y-1">
                                ...
                                {isAsked && <p className="text-[8px] text-blue-300 mt-1">Click to view details</p>}
                              </div>
                            </TooltipContent>
                          </Tooltip>
                        </React.Fragment>
